...
const RegionSetImpl_1 = require("../src/RegionSetImpl");
/**
...
(0, RegionSetImpl_1.implementations)().forEach(SomeRegionSetOfString => describe(SomeRegionSetOfString.name, function () {
    /*
    ...
    it("creates an empty region set for gridSize=0", function () {
        ...
        assert_1.default.deepStrictEqual(empty.owners(new Rect_1.Rect(0, 0, 0, 0)), new Set());
    ...
    it('adding a rectangle to an empty region should create the labeled region)', function () {
        const empty = new SomeRegionSetOfString(10);
        assert_1.default.deepStrictEqual(empty.owners(new Rect_1.Rect(0, 0, 10, 10)), new Set());
        empty.add("A", new Rect_1.Rect(0, 0, 5, 5));
        assert_1.default.deepStrictEqual(empty.owners(new Rect_1.Rect(0, 0, 10, 10)), new Set(["A"]));
        assert_1.default.deepStrictEqual(empty.bounds("A"), new Rect_1.Rect(0, 0, 5, 5));
    });
    ...
    it('adding a rectangle to a non-empty region should not create a new labeled region', function () {
        ...
        region.add("A", new Rect_1.Rect(1, 1, 5, 5));
        region.add("A", new Rect_1.Rect(4, 4, 6, 6));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 10, 10)), new Set(["A"]));
    });
    ...
    it('adding a rectangle that intersects with another labeled region should throw an error', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 5, 5));
        assert_1.default.throws(() => region.add("B", new Rect_1.Rect(3, 3, 8, 8)), Error);
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 10, 10)), new Set(["A"]));
        assert_1.default.deepStrictEqual(region.bounds("A"), new Rect_1.Rect(0, 0, 5, 5));
    });
    ...
    it('adding a rectangle that makes labeled region discontiguous should throw an error', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 5, 5));
        assert_1.default.throws(() => region.add("A", new Rect_1.Rect(6, 6, 9, 8)), Error);
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 10, 10)), new Set(["A"]));
        assert_1.default.deepStrictEqual(region.bounds("A"), new Rect_1.Rect(0, 0, 5, 5));
    });
    ...
    it('adding a rectangle that makes labeled region discontiguous should throw an error', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 5, 5));
        assert_1.default.throws(() => region.add("A", new Rect_1.Rect(5, 5, 9, 8)), Error);
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 10, 10)), new Set(["A"]));
        assert_1.default.deepStrictEqual(region.bounds("A"), new Rect_1.Rect(0, 0, 5, 5));
    });
    ...
    it('adding a rectangle completely within an existing labeled region should not create a new labeled region', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 5, 5));
        region.add("A", new Rect_1.Rect(1, 1, 4, 4));
        assert_1.default.deepStrictEqual(region.bounds("A"), new Rect_1.Rect(0, 0, 5, 5));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 10, 10)), new Set(["A"]));
    });
    ...
    it('adding a rectangle that intersects an existing labeled region should expand the existing labeled region', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 5, 5));
        region.add("A", new Rect_1.Rect(3, 4, 8, 8));
        assert_1.default.deepStrictEqual(region.bounds("A"), new Rect_1.Rect(0, 0, 8, 8));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 10, 10)), new Set(["A"]));
    });
    ...
    it('adding a rectangle that shares an edge with an existing labeled region should expand the existing labeled region', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(2, 2, 5, 5));
        region.add("A", new Rect_1.Rect(5, 3, 7, 7));
        assert_1.default.deepStrictEqual(region.bounds("A"), new Rect_1.Rect(2, 2, 7, 7));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 10, 10)), new Set(["A"]));
    });
    it('adding a rectangle that shares an edge with a different labeled region should be ok', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(2, 2, 5, 5));
        region.add("B", new Rect_1.Rect(5, 3, 7, 7));
        assert_1.default.deepStrictEqual(region.bounds("A"), new Rect_1.Rect(2, 2, 5, 5));
        assert_1.default.deepStrictEqual(region.bounds("B"), new Rect_1.Rect(5, 3, 7, 7));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 10, 10)), new Set(["A", "B"]));
    });
    it('adding a rectangle that shares an edge with a different labeled region should be ok', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 2, 2));
        region.add("B", new Rect_1.Rect(2, 0, 3, 2));
        assert_1.default.deepStrictEqual(region.bounds("A"), new Rect_1.Rect(0, 0, 2, 2));
        assert_1.default.deepStrictEqual(region.bounds("B"), new Rect_1.Rect(2, 0, 3, 2));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 3, 2)), new Set(["A", "B"]));
    });
    // Testing on bounds(): 
    ...
    it('should return undefined if no region with label exists', function () {
        const empty = new SomeRegionSetOfString(10);
        empty.add("A", new Rect_1.Rect(0, 0, 5, 5));
        assert_1.default.strictEqual(empty.bounds("B"), undefined);
    });
    ...
    it('should return the smallest rectangle that contains all grid cells in the labeled region', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 5, 5));
        region.add("B", new Rect_1.Rect(6, 7, 8, 8));
        assert_1.default.deepStrictEqual(region.bounds("A"), new Rect_1.Rect(0, 0, 5, 5));
    });
    ...
    it('should return the smallest rectangle that contains all grid cells in the concave labeled region', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(2, 2, 5, 5));
        region.add("A", new Rect_1.Rect(5, 2, 6, 3));
        region.add("A", new Rect_1.Rect(6, 2, 7, 5));
        assert_1.default.deepStrictEqual(region.bounds("A"), new Rect_1.Rect(2, 2, 7, 5));
    });
    ...
    it('should return undefined when the label passed in does not exist in the region', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(2, 2, 5, 5));
        region.add("B", new Rect_1.Rect(6, 6, 8, 8));
        assert_1.default.strictEqual(region.bounds("C"), undefined);
    });
    // Testing on owners():
    ...
    it('should return an empty set if the rectangle is empty', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 5, 5));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 0, 0)), new Set());
    });
    ...
    it('should return a set with the label if the label completely covers the rectangle', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 5, 5));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(1, 1, 3, 3)), new Set(["A"]));
    });
    ...
    it('should return a set with the label if the label is completely inside the rectangle', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(1, 1, 3, 3));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 5, 5)), new Set(["A"]));
    });
    // nonempty rectangle, 1 label in region, label is completely inside the rectangle, there is a shared edge
    it('should return a set with the label if the label is completely inside the rectangle', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(3, 1, 5, 4));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 5, 5)), new Set(["A"]));
    });
    ...
    it('should return an empty set if the label is not inside the rectangle', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(5, 3, 7, 6));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 5, 5)), new Set());
    });
    ...
    it('should return a set with all the labels inside the rectangle', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 5, 5));
        region.add("B", new Rect_1.Rect(6, 6, 7, 7));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(0, 0, 10, 10)), new Set(["A", "B"]));
    });
    ...
    it('should return a set with only the labels inside the rectangle', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 5, 5));
        region.add("B", new Rect_1.Rect(7, 7, 9, 9));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(6, 6, 10, 10)), new Set(["B"]));
    });
    ...
    it('should return an empty set if no labels are inside the rectangle', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 3, 3));
        region.add("B", new Rect_1.Rect(7, 8, 9, 9));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(4, 5, 7, 7)), new Set());
    });
    ...
    it('should return a set with all the intersecting labels', function () {
        ...
        region.add("A", new Rect_1.Rect(0, 0, 3, 3));
        region.add("B", new Rect_1.Rect(7, 8, 9, 9));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(2, 2, 6, 6)), new Set(["A"]));
    });
    // nonempty rectangle, >1 labels in region, labels intersect with >1 rectangles
    it('should return a set with all the intersecting labels', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 3, 3));
        region.add("B", new Rect_1.Rect(4, 5, 7, 7));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(2, 2, 6, 6)), new Set(["A", "B"]));
    });
    it('should give empty set when area is zero', function () {
        const region = new SomeRegionSetOfString(10);
        region.add("A", new Rect_1.Rect(0, 0, 3, 3));
        region.add("B", new Rect_1.Rect(4, 5, 7, 7));
        assert_1.default.deepStrictEqual(region.owners(new Rect_1.Rect(2, 2, 2, 2)), new Set());
    });
}));
//# sourceMappingURL=RegionSetTest.js.map