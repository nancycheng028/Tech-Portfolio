...
describe('City', function () {
    ...
    it("creates an empty region set for gridSize=0", function () {
        const empty = new City_1.City(0);
        assert_1.default.strictEqual(empty.gridSize, 0);
        assert_1.default.deepStrictEqual(empty.owners(new Rect_1.Rect(0, 0, 0, 0)), new Set(), 'expect no owners in an empty region');
        assert_1.default.strictEqual(empty.bounds('A'), undefined);
    });
    // gridSize = 1
    it('creates an empty region set with gridSize = 1', function () {
        const regionSet = new City_1.City(1);
        assert_1.default.strictEqual(regionSet.gridSize, 1);
        assert_1.default.deepStrictEqual(regionSet.owners(new Rect_1.Rect(0, 0, 0, 0)), new Set());
        assert_1.default.strictEqual(regionSet.bounds('A'), undefined);
    });
    // gridSize > 1
    it("creates an empty region set for a given grid size > 1", function () {
        const empty = new City_1.City(10);
        assert_1.default.strictEqual(empty.gridSize, 10);
        assert_1.default.deepStrictEqual(empty.owners(new Rect_1.Rect(0, 0, 10, 10)), new Set());
        assert_1.default.strictEqual(empty.bounds('A'), undefined);
    });
    // Testing on expand():
    ...
    it('adds a rectangle to an empty region without error', function () {
        const city = new City_1.City(5);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 1, 1));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 1, 1)), new Set(['A']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 1, 1), height: 1 });
    });
    // Adding to non-empty region, floor 0, no error
    it('adds a rectangle to a non-empty region on floor 0 without error', function () {
        const city = new City_1.City(5);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 1, 1));
        city.expand('A', 0, new Rect_1.Rect(0, 0, 2, 2));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 2, 2)), new Set(['A']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 2, 2), height: 1 });
    });
    // Adding to floor 1, non-empty, no error
    it('adds a rectangle to floor 1 without error', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 1, 1));
        city.expand('A', 1, new Rect_1.Rect(0, 0, 1, 1));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 1, 1)), new Set(['A']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 1, 1), height: 2 });
    });
    ...
    it('adds a rectangle to top floor that intersects with existing label without error', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 2, 2));
        city.expand('A', 1, new Rect_1.Rect(0, 0, 2, 2));
        city.expand('A', 2, new Rect_1.Rect(0, 0, 2, 2));
        city.expand('A', 2, new Rect_1.Rect(1, 1, 2, 2));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 2, 2)), new Set(['A']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 2, 2), height: 3 });
    });
    ...
    it('adds a rectangle to middle floor that shares a face with existing label without error', function () {
        ...
        city.expand('A', 0, new Rect_1.Rect(0, 0, 1, 1));
        city.expand('A', 1, new Rect_1.Rect(0, 0, 1, 1));
        city.expand('A', 1, new Rect_1.Rect(1, 0, 2, 1));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 2, 1)), new Set(['A']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 2, 1), height: 2 });
    });
    ...
    it('throws error when adding a rectangle intersects with another labeled building', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 1, 1));
        city.expand('B', 0, new Rect_1.Rect(1, 0, 3, 2));
        assert_1.default.throws(() => city.expand('A', 0, new Rect_1.Rect(0, 0, 2, 2)), Error);
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 3, 3)), new Set(['A', 'B']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 1, 1), height: 1 });
        assert_1.default.deepStrictEqual(city.bounds('B'), { footprint: new Rect_1.Rect(1, 0, 3, 2), height: 1 });
    });
    ...
    it('throws error when adding a rectangle intersects with another labeled building', function () {
        ...
        city.expand('A', 0, new Rect_1.Rect(0, 0, 1, 1));
        city.expand('B', 0, new Rect_1.Rect(1, 0, 3, 2));
        city.expand('B', 1, new Rect_1.Rect(1, 0, 3, 2));
        assert_1.default.throws(() => city.expand('A', 1, new Rect_1.Rect(0, 0, 2, 2)), Error);
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 3, 2)), new Set(['A', 'B']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 1, 1), height: 1 });
        assert_1.default.deepStrictEqual(city.bounds('B'), { footprint: new Rect_1.Rect(1, 0, 3, 2), height: 2 });
    });
    // Error: make the building discontiguous
    it('throws an error when expansion would make the building discontiguous', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 1, 1));
        assert_1.default.throws(() => city.expand('A', 0, new Rect_1.Rect(2, 2, 3, 3)), Error);
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 2, 2)), new Set(['A']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 1, 1), height: 1 });
    });
    // Error: make the building discontiguous
    it('throws an error when expansion of a new floor would make the building discontiguous', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 1, 1));
        assert_1.default.throws(() => city.expand('A', 1, new Rect_1.Rect(2, 2, 3, 3)), Error);
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 2, 2)), new Set(['A']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 1, 1), height: 1 });
    });
    // Error: make the building discontiguous
    it('throws an error when expansion of a new floor would make the building discontiguous', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 1, 1));
        assert_1.default.throws(() => city.expand('A', 1, new Rect_1.Rect(1, 1, 2, 2)), Error);
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 2, 2)), new Set(['A']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 1, 1), height: 1 });
    });
    // Error: make the building discontiguous
    it('throws an error when expansion of a new floor would make the building discontiguous', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 1, 1));
        assert_1.default.throws(() => city.expand('A', 2, new Rect_1.Rect(0, 0, 1, 1)), Error);
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 2, 2)), new Set(['A']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 1, 1), height: 1 });
    });
    ...
    it('throws an error when expansion would make the floor discontiguous', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 3, 1));
        city.expand('A', 1, new Rect_1.Rect(0, 0, 1, 1));
        assert_1.default.throws(() => city.expand('A', 1, new Rect_1.Rect(2, 0, 3, 1)), Error);
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 3, 3)), new Set(['A']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 3, 1), height: 2 });
    });
    ...
    it('throws an error when expansion would make the building ungrounded', function () {
        const city = new City_1.City(3);
        assert_1.default.throws(() => city.expand('A', 1, new Rect_1.Rect(2, 2, 3, 3)), Error);
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 3, 3)), new Set());
        assert_1.default.strictEqual(city.bounds('A'), undefined);
    });
    ...
    it('throws an error when expansion would make the building ungrounded', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 1, 1));
        assert_1.default.throws(() => city.expand('B', 1, new Rect_1.Rect(0, 0, 1, 1)), Error);
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 3, 3)), new Set(['A']));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 1, 1), height: 1 });
    });
    // testing on owners():
    ...
    it('returns an empty set if rectangle is empty and contains no buildings', function () {
        const city = new City_1.City(5);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 1, 1));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(3, 1, 3, 2)), new Set());
    });
    // nonempty rectangle, 0 building in city
    it('empty city should have no owners', function () {
        assert_1.default.deepStrictEqual(new City_1.City(10).owners(new Rect_1.Rect(0, 0, 10, 10)), new Set());
    });
    ...
    it('returns the owner of the single building of floor 1 that intersects with a nonempty rectangle', function () {
        const city = new City_1.City(5);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 2, 2));
        city.expand('A', 1, new Rect_1.Rect(1, 1, 3, 3));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(1, 1, 3, 3)), new Set(['A']));
    });
    ...
    it('returns no owner of the single building of floor 0 that shares an edge with the nonempty rectangle', function () {
        const city = new City_1.City(5);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 2, 2));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(2, 0, 3, 2)), new Set());
    });
    ...
    it('returns no owner of the single building of floor 2 that is outisde the nonempty rectangle', function () {
        const city = new City_1.City(5);
        city.expand('A', 0, new Rect_1.Rect(1, 1, 2, 2));
        city.expand('A', 1, new Rect_1.Rect(1, 1, 2, 2));
        city.expand('A', 2, new Rect_1.Rect(1, 1, 2, 2));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(2, 2, 3, 3)), new Set());
    });
    ...
    it('returns the owners of all buildings of floor 0 that are within the nonempty rectangle', function () {
        const city = new City_1.City(5);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 2, 2));
        city.expand('B', 0, new Rect_1.Rect(2, 2, 3, 3));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(0, 0, 3, 3)), new Set(['A', 'B']));
    });
    ...
    it('returns the owners of all buildings that intersect with the nonempty rectangle', function () {
        ...
        city.expand('A', 0, new Rect_1.Rect(0, 0, 2, 2));
        city.expand('A', 1, new Rect_1.Rect(1, 1, 3, 3));
        city.expand('B', 0, new Rect_1.Rect(2, 0, 4, 1));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(2, 0, 3, 2)), new Set(['A', 'B']));
    });
    // nonempty rectangle, > 1 buildings in city, all buildings in rectangle, floor > 1
    it('returns the owners of all buildings that intersect with the nonempty rectangle', function () {
        const city = new City_1.City(5);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 2, 2));
        city.expand('A', 1, new Rect_1.Rect(1, 1, 3, 3));
        city.expand('A', 2, new Rect_1.Rect(2, 2, 4, 4));
        city.expand('B', 0, new Rect_1.Rect(2, 0, 4, 1));
        city.expand('B', 1, new Rect_1.Rect(1, 0, 3, 1));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(3, 0, 4, 4)), new Set(['A', 'B']));
    });
    ...
    it('returns the owners of the correct buildings that intersect with the nonempty rectangle', function () {
        ...
        city.expand('A', 0, new Rect_1.Rect(0, 0, 2, 2));
        city.expand('B', 0, new Rect_1.Rect(2, 0, 4, 1));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(3, 0, 4, 2)), new Set(['B']));
    });
    ...
    it('returns the owners of the correct buildings that intersect with the nonempty rectangle', function () {
        ...
        city.expand('A', 0, new Rect_1.Rect(0, 0, 2, 2));
        city.expand('B', 0, new Rect_1.Rect(2, 0, 4, 1));
        city.expand('B', 1, new Rect_1.Rect(2, 0, 3, 2));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(2, 1, 4, 2)), new Set(['B']));
    });
    ...
    it('returns the owners of the correct buildings that intersect with the nonempty rectangle', function () {
        ...
        city.expand('B', 0, new Rect_1.Rect(2, 0, 4, 1));
        city.expand('B', 1, new Rect_1.Rect(2, 0, 3, 2));
        city.expand('B', 2, new Rect_1.Rect(2, 1, 4, 2));
        city.expand('C', 0, new Rect_1.Rect(0, 2, 3, 3));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(2, 1, 3, 3)), new Set(['B', 'C']));
    });
    // nonempty rectangle, > 1 buildings in city, some buildings in rectangle, floor > 1
    it('returns the owners of the correct buildings that intersect with the nonempty rectangle', function () {
        const city = new City_1.City(5);
        ...
        city.expand('B', 2, new Rect_1.Rect(2, 1, 4, 2));
        city.expand('C', 0, new Rect_1.Rect(0, 2, 3, 3));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(3, 1, 4, 2)), new Set(['B']));
    });
    ...
    it('returns no building when none is inside the nonempty rectangle', function () {
        ...
        city.expand('B', 0, new Rect_1.Rect(2, 0, 4, 1));
        city.expand('C', 0, new Rect_1.Rect(0, 2, 3, 3));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(2, 1, 4, 2)), new Set());
    });
    ...
    it('returns no building when none is inside the nonempty rectangle', function () {
        ...
        city.expand('B', 0, new Rect_1.Rect(2, 0, 4, 1));
        city.expand('C', 0, new Rect_1.Rect(0, 2, 3, 3));
        city.expand('C', 1, new Rect_1.Rect(2, 2, 4, 3));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(2, 1, 4, 2)), new Set());
    });
    // nonempty rectangle, > 1 buildings in city, no building in rectangle, floor > 1
    it('returns no building when none is inside the nonempty rectangle', function () {
        ...
        city.expand('B', 2, new Rect_1.Rect(2, 1, 4, 2));
        city.expand('C', 0, new Rect_1.Rect(0, 2, 3, 3));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(3, 2, 4, 3)), new Set());
    });
    ...
    it('returns no building when none is inside the nonempty rectangle', function () {
        ...
        city.expand('B', 2, new Rect_1.Rect(2, 1, 4, 2));
        city.expand('C', 0, new Rect_1.Rect(0, 2, 3, 3));
        assert_1.default.deepStrictEqual(city.owners(new Rect_1.Rect(1, 3, 3, 4)), new Set());
    });
    // testing on bounds():
    ...
    it('returns undefined if no building with label exists', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 2, 2));
        assert_1.default.strictEqual(city.bounds('B'), undefined);
    });
    ...
    it('returns correct bounds when building with label exists, height = 0', function () {
        ...
        city.expand('A', 0, new Rect_1.Rect(0, 0, 3, 1));
        city.expand('A', 0, new Rect_1.Rect(1, 1, 2, 2));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 3, 2), height: 1 });
    });
    // 1 building in city, building with label exists, height > 0, building is rectangle, shape is different among floors
    it('returns correct bounds when building with label exists, height > 0', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 3, 1));
        city.expand('A', 1, new Rect_1.Rect(0, 0, 1, 2));
        city.expand('A', 2, new Rect_1.Rect(0, 1, 3, 2));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 3, 2), height: 3 });
    });
    ...
    it('returns correct bounds when building with label exists, height > 0', function () {
        ...
        city.expand('A', 1, new Rect_1.Rect(0, 0, 1, 2));
        city.expand('A', 1, new Rect_1.Rect(1, 0, 2, 1));
        city.expand('A', 1, new Rect_1.Rect(2, 0, 3, 2));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 3, 2), height: 2 });
    });
    // 1 building in city, building with label exists, height > 0, building is concave, same shape among floors
    it('returns correct bounds when building with label exists, height > 0', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 3, 1));
        city.expand('A', 0, new Rect_1.Rect(0, 1, 1, 2));
        city.expand('A', 0, new Rect_1.Rect(2, 1, 3, 2));
        city.expand('A', 1, new Rect_1.Rect(0, 0, 3, 1));
        city.expand('A', 1, new Rect_1.Rect(0, 1, 1, 2));
        city.expand('A', 1, new Rect_1.Rect(2, 1, 3, 2));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 3, 2), height: 2 });
    });
    // > 1 building in city, building with label exists, height = 0, building is rectangle
    it('returns correct bounds when building with label exists, height = 0', function () {
        const city = new City_1.City(3);
        city.expand('A', 0, new Rect_1.Rect(0, 0, 3, 1));
        city.expand('B', 0, new Rect_1.Rect(0, 1, 1, 2));
        assert_1.default.deepStrictEqual(city.bounds('A'), { footprint: new Rect_1.Rect(0, 0, 3, 1), height: 1 });
    });
});
//# sourceMappingURL=CityTest.js.map